...
drop table #dbsize
create table #dbsize
(Dbname varchar(50),dbstatus varchar(50),Recovery_Model varchar(50) default ('NA'), file_Size_MB decimal(20,2)default (0),Space_Used_MB decimal(20,2)default (0),Free_Space_MB decimal(20,2) default (0))
go
...
(Dbname varchar(50), Log_File_Size_MB decimal(20,2)default (0),log_Space_Used_MB decimal(20,2)default (0),log_Free_Space_MB decimal(20,2)default (0))
go
...
'use ?;SELECT database_name = db_name()
    ,database_size = ltrim(str((convert(DECIMAL(25, 2), dbsize) + convert(DECIMAL(15, 2), logsize)) * 8192 / 1048576, 15, 2) + ''MB'')
...
select name,CONVERT(varchar(50),DATABASEPROPERTYEX(name,'status')),recovery_model_desc from sys.databases
--select * from #dbsize
